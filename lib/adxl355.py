...
# Data Registers
# 3 Registers for each axis(20 bits, 4 bits is reserved)
REG_XDATA3 = 0x08
REG_XDATA2 = 0x09
REG_XDATA1 = 0x0A
REG_YDATA3 = 0x0B
...
# Output Data Rate(Default: 500Hz)
SET_ODR_4000     = 0b0000
SET_ODR_2000     = 0b0001
SET_ODR_1000     = 0b0010
SET_ODR_500      = 0b0011
...
class ADXL355():
    ...
    def start(self):
        """
        measurement mode: working temperature and accelerometer sensor
        """
    ...
    def stop(self):
        """
        standby mode: no working temperature and accelerometer sensor
        """
        tmp = self.read(REG_POWER_CTL)
